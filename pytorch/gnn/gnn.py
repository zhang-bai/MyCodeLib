...
class GNN(nn.Module):
    def __init__(self, opt):
        ...
        self.m1 = GraphConvolution(opt_)

        opt_ = dict([('in', opt['hidden_dim']), ('out', opt['num_class'])])
        self.m2 = GraphConvolution(opt_)
    ...
    def forward_aux(self, x, adj, target=None, train_idx= None, mixup_input= False, mixup_hidden = False, mixup_alpha = 0.0,layer_mix=None):
